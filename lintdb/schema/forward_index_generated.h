...
struct ForwardIndexDocumentBuilder {
  ...
  void add_residuals(::flatbuffers::Offset<::flatbuffers::Vector<uint8_t>> residuals) {
...
inline const lintdb::ForwardIndexDocument *GetForwardIndexDocument(const void *buf) {
  return ::flatbuffers::GetRoot<lintdb::ForwardIndexDocument>(buf);
}

inline const lintdb::ForwardIndexDocument *GetSizePrefixedForwardIndexDocument(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<lintdb::ForwardIndexDocument>(buf);
}
...
inline bool VerifySizePrefixedForwardIndexDocumentBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<lintdb::ForwardIndexDocument>(nullptr);
}
