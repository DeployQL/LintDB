...
struct DocumentClusterMapping FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
...
inline const lintdb::DocumentClusterMapping *GetDocumentClusterMapping(const void *buf) {
  return ::flatbuffers::GetRoot<lintdb::DocumentClusterMapping>(buf);
}

inline const lintdb::DocumentClusterMapping *GetSizePrefixedDocumentClusterMapping(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<lintdb::DocumentClusterMapping>(buf);
}
...
inline bool VerifySizePrefixedDocumentClusterMappingBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<lintdb::DocumentClusterMapping>(nullptr);
}
