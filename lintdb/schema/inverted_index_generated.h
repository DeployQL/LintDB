...
struct InvertedIndexDocument FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
...
inline const lintdb::InvertedIndexDocument *GetInvertedIndexDocument(const void *buf) {
  return ::flatbuffers::GetRoot<lintdb::InvertedIndexDocument>(buf);
}

inline const lintdb::InvertedIndexDocument *GetSizePrefixedInvertedIndexDocument(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<lintdb::InvertedIndexDocument>(buf);
}
...
inline bool VerifySizePrefixedInvertedIndexDocumentBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<lintdb::InvertedIndexDocument>(nullptr);
}
