...
namespace lintdb {
/**
 * DocCandidate keeps track of the emvb score, doc id, and index position in doc
 * codes.
 *
...
struct DocCandidate {
    ScoreType score;
    idx_t doc_id;
    size_t index_position; // index_position is a hack to keep track of the
                           // index position through multithreading.
};

/**
 * EMVBRetriever implements the optimizations in:
