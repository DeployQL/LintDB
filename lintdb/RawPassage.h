...
namespace lintdb {
    struct RawPassage {
        ...
        // this is an array, and can be any number of embeddings, but they'll all be indexed together.
        EmbeddingBlock embedding_block;
        // id is a unique identifier for the document or passage.
        // it must be an integer. we enable document ids to be strings that we can lookup after retrieval.
        idx_t id;
