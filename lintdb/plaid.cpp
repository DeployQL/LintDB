...
namespace lintdb {
    ...
    float score_document_by_residuals(
        ...
        // use BLAS functions to matmul doc residuals with the transposed query vectors.
        // we'll use the sum of the max scores for each centroid.
        ...
        cblas_sgemm(
            ...
            k, // leading dimension is the length of the first dimension (columns)
